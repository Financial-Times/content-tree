...
typescript-json-schema --validationKeywords sparkGenerateStoryblock sparkUploadField --noExtraProps --required  content-tree.ts ContentTree.transit.Root > schemas/transit-tree.schema.json
